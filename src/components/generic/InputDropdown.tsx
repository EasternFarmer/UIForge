// https://github.com/Jayd-H/joker-forge/blob/30b5336df49f2cf03b7300ba9febeae91154d904/src/components/generic/InputDropdown.tsx
    ...
    return (
      <ChevronDownIcon
        className={`${iconSizeClasses[size]
          } text-mint stroke-2 transition-transform ${isOpen ? "rotate-180" : ""
          }`}
      />
    );
  };
    ...
    <div className="flex flex-col w-full select-none">
      ...
      <div className="relative">
        <div
          ref={buttonRef}
          className={`
            relative flex items-center bg-black-dark text-white-light ${sizeClasses[size].padding
            }
        ...
        >
          ...
          <div
            className={`w-full truncate ${separator ? sizeClasses[size].contentPadding : "pl-10"
              }`}
          >
            {displayText}
          </div>
